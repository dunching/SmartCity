...
ABuilding_StructuralFramework::ABuilding_StructuralFramework(
...
void ABuilding_StructuralFramework::ReplaceImp(
	AActor* ActorPtr
	)
{
...
void ABuilding_StructuralFramework::SwitchState(
	EState State
	)
{
	switch (State)
